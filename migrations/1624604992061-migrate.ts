...
export class migrate1624604992061 implements MigrationInterface {
    name = 'migrate1624604992061'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Board" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(120) NOT NULL, "columns" text NOT NULL, CONSTRAINT "PK_a898df2ad483f1ad130bdcb56cc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`INSERT INTO "User"(id, name, login, password) VALUES(DEFAULT, 'admin', 'admin', '$2b$10$w9oRv2BKug/VZcTxajBQSOKwN0/HmHmeILNjmMG1AQmmvohpm.rOW')`)
    }
